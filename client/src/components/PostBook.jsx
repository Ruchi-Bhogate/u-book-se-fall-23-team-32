  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://u-book-se-fall-23-team-32-hm4hr39j8-ruchis-projects-419a70ff.vercel.app/userview/postbook",
        formData,
        {
          headers: {
        ...
        >
          ...
          <div className="form-group">
            ...
            <LoadScript googleMapsApiKey="AIzaSyAuhAVZf10KG1trTGAtF25hLt7aYkLIAfs">
              ...
              >
                <Marker
                  key={`${bookData.location.lat}-${bookData.location.lng}`}
                  position={bookData.location}
                />
              </GoogleMap>
            </LoadScript>
          </div>
